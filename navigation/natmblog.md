...
First, brainstorm the ideas. Use the whiteboards and talk with your team about what you want to establish, and put it on a Kanban board if you want to

Next, open an LLM(Claude specifically, it’s the best for coding), and ask it to bring your ideas to life. If you’re in CSP or further ask it to use HTML for frontend as it’s the most widely used language and then use Javascript or something for the backend

Make sure to write some of the code by yourself however so you’re not completely vibe coding and so that you show yourself that you can understand the syntax and that you know how to code

ONLY IF YOU’RE IN CSP OR CSA: After that, make a SQL database for storing any variables if you have any inputs into your site and integrate it with your repository

After that, apparently AI tends to “fluff” up UIs so go ahead and look into the HTML code or the code that the user will see and look through each element and remove any unnecessary items

Finally, get playtesters or testers to play/use your game/site to get feedback from the end user, log the feedback, and then improve your game using the feedback to turn it into a more polished version that can be comfortably shown to people
...
<div class="image-gallery">
   <img src="{{site.baseurl}}/images/about/image1.jpeg" alt="Image 1">
  <img src="{{site.baseurl}}/images/about/image2.jpeg" alt="Image 2">
  <img src="{{site.baseurl}}/images/about/image3.jpeg" alt="Image 3">
  <img src="{{site.baseurl}}/images/about/image4.jpeg" alt="Image 4">
  <img src="{{site.baseurl}}/images/about/image5.jpeg" alt="Image 5">
  <img src="{{site.baseurl}}/images/about/image6.jpeg" alt="Image 6">
  <img src="{{site.baseurl}}/images/about/image7.jpeg" alt="Image 7">
  <img src="{{site.baseurl}}/images/about/image8.jpeg" alt="Image 8">
  <img src="{{site.baseurl}}/images/about/image9.jpeg" alt="Image 9">
</div>
